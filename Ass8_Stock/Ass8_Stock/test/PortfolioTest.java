...
public class PortfolioTest {
  ...
  public void test1() {
     ...
     */
    assertEquals(0, p1.getTotalCostByDate(LocalDate.of(2000, 2, 26)), 4);
    assertEquals(56000, p1.getTotalCostByDate(LocalDate.of(2004, 2, 26)), 4);
    assertEquals(396900, p1.getTotalCostByDate(LocalDate.of(2020, 2, 26)), 4);
    /**
     * test for getTotalCost().
     */
    assertEquals(396900, p1.getTotalCost(), 4);
    assertEquals(0, p1.getTotalCostByDate(LocalDate.of(2000, 2, 26)), 4);
    assertEquals(293600, p1.getTotalCostByDate(LocalDate.of(2010, 2, 26)), 4);
    assertEquals(396900, p1.getTotalCostByDate(LocalDate.of(2020, 2, 26)), 4);
    /**
