...
public class FreecellModelTest {
  ...
  public void testInvalidBuilderInvalidOpenPileNumberSingle() {
    try {
      ...
      assertEquals(ModelErrMess.INVALID_OPEN_PILE_NUMBER.getMessage(), e.getMessage());
    }
  }
  ...
  public void testInvalidBuilderInvalidCascadePileNumberSingle() {
    try {
      ...
      assertEquals(ModelErrMess.INVALID_CASCADE_PILE_NUMBER.getMessage(), e.getMessage());
    }
  }
  ...
  public void testInvalidStartGameNullDeck() {
    try {
      ...
      assertEquals(ModelErrMess.NULL_DECK.getMessage(), e.getMessage());
    }
    try {
  ...
  public void testInvalidStartGameDeckWrongSize() {
    try {
      ...
      assertEquals(ModelErrMess.INVALID_DECK_SIZE.getMessage(), e.getMessage());
    }
    try {
  ...
  public void testInvalidStartGameDuplicateDeck() {
    try {
      ...
      assertEquals(ModelErrMess.DUPLICATE_CARD_IN_DECK.getMessage(), e.getMessage());
    }
    try {
      emptyDeck = new ArrayList<>();
      for (int i = 1; i <= 52; i++) {
  ...
  public void testInvalidStartGameInvalidCardValue() {
    try {
      ...
      assertEquals(ModelErrMess.INVALID_CARD_VALUE.getMessage(), e.getMessage());
    }
  }
  ...
  public void testInvalidMoveBeforeGameStarted() {
    try {
      ...
      assertEquals(ModelErrMess.GAME_NOT_STARTED.getMessage(), e.getMessage());
    }
  }
