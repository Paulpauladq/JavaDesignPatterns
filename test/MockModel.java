...
public class MockModel implements SimulatorOperations<Stock> {
  ...
  @Override
  public void saveStrategy(String strategyName,
                           double money, Map<String, Double> ratioMap, LocalDate beginDate,
  ...
  @Override
  public void retrieveStrategyToPort(String strategyName, String portfolioName) throws IOException {
    return;
  }
