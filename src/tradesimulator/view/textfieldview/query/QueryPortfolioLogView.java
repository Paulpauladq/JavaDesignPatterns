...
/**
 * Query portfolio log view presents the page of this view.
 */
public class QueryPortfolioLogView extends JFrame implements ITextFieldView {
  ...
  /**
   * Construct the query portfolio log view.
   *
   * @param caption    the caption String
   * @param controller the controller object
   */
  public QueryPortfolioLogView(String caption, IController<Stock> controller) {
    super(caption);
    ...
    queryBtn.setActionCommand("Query Portfolio Log Operation Button");

    backBtn = new JButton("Back");
    backBtn.setActionCommand("Query Portfolio Log Operation Back Button");
    status = new JLabel("");
